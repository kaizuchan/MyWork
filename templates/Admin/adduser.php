...
<body>
  ...
  <input type="hidden" class="p-country-name" value="Japan">
    ...
    <div class="input-group mb-3 ">
      ...
      <input name="employee_id" value="<?= setValue('employee_id') ?>" type="text" id="validationTextarea" class="form-control" placeholder="社員ID" aria-label="社員ID" aria-describedby="basic-addon1" required>
    </div>

    <div class="input-group mb-3">
      <span class="input-group-text">姓</span>
      <input name="last_name" value="<?= setValue('last_name') ?>" type="text" class="form-control" placeholder="姓" aria-label="姓" required>
      <span class="input-group-text">名</span>
      <input name="first_name" value="<?= setValue('first_name') ?>" type="text" class="form-control" placeholder="名" aria-label="名" required>
    </div>

    <div class="input-group mb-3">
      <span class="input-group-text">セイ</span>
      <input name="last_name_kana" value="<?= setValue('last_name_kana') ?>" type="text" class="form-control" placeholder="セイ" aria-label="セイ" pattern="[\u30A1-\u30F6]*" required>
      <span class="input-group-text">メイ</span>
      <input name="first_name_kana" value="<?= setValue('first_name_kana') ?>" type="text" class="form-control" placeholder="メイ" aria-label="メイ" pattern="[\u30A1-\u30F6]*" required>
    </div>

    <div class="input-group mb-3 ">
      <span class="input-group-text" id="basic-addon1">電話番号</span>
      <input name="phone_number" value="<?= setValue('phone_number') ?>" type="text" id="validationTextarea" class="form-control" placeholder="電話番号" aria-label="電話番号" aria-describedby="basic-addon1" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}" required>
    </div>
...
?>
    ...
    <div class="input-group mb-3 ">
      ...
      <input name="city" value="<?= setValue('city') ?>" type="text" id="validationTextarea" class="form-control p-locality p-street-address" placeholder="市区町村" aria-label="市区町村" aria-describedby="basic-addon1" required>
    </div>

    <div class="input-group mb-3 ">
      <span class="input-group-text" id="basic-addon1">番地</span>
      <input name="block" value="<?= setValue('block') ?>" type="text" id="validationTextarea" class="form-control" placeholder="○丁目○番地" aria-label="番地" aria-describedby="basic-addon1" required>
    </div>

    <div class="input-group mb-3 ">
      <span class="input-group-text" id="basic-addon1">建物名・部屋番号</span>
      <input name="building" value="<?= setValue('building') ?>" type="text" id="validationTextarea" class="form-control" placeholder="建物名・部屋番号" aria-label="建物名・部屋番号" aria-describedby="basic-addon1">
    </div>
