...
<body>
  ...
  <form class="was-validated" method="POST">
    ...
    <div class="input-group mb-3">
      ...
      <input name="last_name" type="text" class="form-control" placeholder="姓" aria-label="姓">
      <span class="input-group-text">名</span>
      <input name="first_name" type="text" class="form-control" placeholder="名" aria-label="名">
    </div>

    <div class="input-group mb-3">
      <span class="input-group-text">セイ</span>
      <input name="last_name_kana" type="text" class="form-control" placeholder="セイ" aria-label="セイ" pattern="[\u30A1-\u30F6]*">
      <span class="input-group-text">メイ</span>
      <input name="first_name_kana" type="text" class="form-control" placeholder="メイ" aria-label="メイ" pattern="[\u30A1-\u30F6]*">
    </div>

    <div class="input-group mb-3 ">
      <span class="input-group-text" id="basic-addon1">電話番号</span>
      <input name="phone_number" type="text" id="validationTextarea" class="form-control" placeholder="電話番号" aria-label="電話番号" aria-describedby="basic-addon1" pattern="\d{2,4}-?\d{2,4}-?\d{3,4}">
    </div>

    <div class="input-group mb-3 ">
      <span class="input-group-text" id="basic-addon1">メールアドレス</span>
      <input name="email" type="email" id="validationTextarea" class="form-control" placeholder="メールアドレス" aria-label="メールアドレス" aria-describedby="basic-addon1">
    </div>
    ...
    <div class="input-group mb-3 ">
      ...
      <input name="postalcode" type="text" id="validationTextarea" class="form-control" placeholder="xxx-xxxx" aria-label="郵便番号" aria-describedby="basic-addon1"  pattern="\d{3}-?\d{4}">
    </div>
    ...
    <div class="input-group mb-3 ">
      ...
      <input name="city" type="text" id="validationTextarea" class="form-control" placeholder="市区町村" aria-label="市区町村" aria-describedby="basic-addon1">
    </div>

    <div class="input-group mb-3 ">
      <span class="input-group-text" id="basic-addon1">番地</span>
      <input name="block" type="text" id="validationTextarea" class="form-control" placeholder="○丁目○番地" aria-label="番地" aria-describedby="basic-addon1">
    </div>
