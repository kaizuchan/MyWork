  ...
  <div id="main">
    <div class="Card">
      ...
      <input type="hidden" class="p-country-name" value="Japan">
        ...
        <div class="input-group mb-3 ">
          ...
          <input name="email" value="<?= setValue('email') ?>" type="email" id="validationTextarea" class="form-control" placeholder="例）hal.nagoya@gmail.com" aria-label="メールアドレス" aria-describedby="basic-addon1" required>
        </div>
    ...
    ?>
        ...
        <div class="input-group mb-3 ">
          ...
          <input name="city" value="<?= setValue('city') ?>" type="text" id="validationTextarea" class="form-control p-locality p-street-address" placeholder="例）名古屋市東区東桜" aria-label="市区町村" aria-describedby="basic-addon1"  pattern=".*\S+.*" required>
        </div>

        <div class="input-group mb-3 ">
          <span class="input-group-text" id="basic-addon1">番地</span>
          <input name="block" value="<?= setValue('block') ?>" type="text" id="validationTextarea" class="form-control p-extended-address" placeholder="例）1丁目9-26" aria-label="番地" aria-describedby="basic-addon1"  pattern=".*\S+.*" required>
        </div>

        <div class="input-group mb-3 ">
          <span class="input-group-text" id="basic-addon1">建物名・部屋番号</span>
          <input name="building" value="<?= setValue('building') ?>" type="text" id="validationTextarea" class="form-control" placeholder="例）IKKOパーク栄ビル3階階" aria-label="建物名・部屋番号" aria-describedby="basic-addon1">
        </div>

        <div class="input-group mb-3 ">
          <span class="input-group-text" id="basic-addon1">パスワード</span>
          <input name="password" type="password" id="userpass" class="form-control" placeholder="" aria-label="パスワード" aria-describedby="basic-addon1" pattern="(?=.*?[a-z])(?=.*?[A-Z])(?=.*?\d)[a-zA-Z\d]{8,}" oninput="CheckPassword()" required>
        </div>
